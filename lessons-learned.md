...
## Enseignements Clés (ajouts à la liste existante « Enseignements Clés pour les Projets Futurs »)
...
6. **Un snapshot etcd restaure l'état des objets Kubernetes, pas l'état
...
7. **Confirmer que les snapshots etcd fonctionnent (2026-08-01) et
